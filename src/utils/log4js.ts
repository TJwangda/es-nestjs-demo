...
// 实例化
const logger = Log4js.getLogger();//调用默认的category
// const logger = Log4js.getLogger("error");//调用指定的category
...
export class Logger {
    ...
    static debug(...args) {
        ...
        const loggerCustom = Log4js.getLogger('http');//指定category
    ...
    static info(...args) {
        const loggerCustom = Log4js.getLogger('infoc');//指定category
        loggerCustom.info(Logger.getStackTrace(), ...args);
    }
    ...
    static error(...args) {
        const loggerCustom = Log4js.getLogger('errorsc');//指定category
